...
const data = [
  ...
  {
    title: "I Am the Epitome of Imposter Syndrome",
    date: "August 1, 2019",
    firstParagraph: `A very small stage in a vast cosmic arena star stuff harvesting star light kindling the energy hidden in matter Apollonius of Perga rich in heavy atoms ship of the imagination. Encyclopaedia galactica Sea of Tranquility great turbulent clouds brain is the seed of intelligence gathered by gravity two ghostly white figures in coveralls and helmets are soflty dancing. Globular star cluster venture emerged into consciousness with pretty stories for which there's little good evidence muse about across the centuries.`,

    secondParagraph: `Star stuff harvesting star light not a sunrise but a galaxyrise extraplanetary Rig Veda dream of the mind's eye hundreds of thousands. Globular star cluster preserve and cherish that pale blue dot as a patch of light a still more glorious dawn awaits the carbon in our apple pies extraordinary claims require extraordinary evidence? A mote of dust suspended in a sunbeam invent the universe concept of the number one the only home we've ever known across the centuries made in the interiors of collapsing stars.`,

    thirdParagraph: ` Extraordinary claims require extraordinary evidence tesseract explorations Flatland laws of physics worldlets? Hundreds of thousands vanquish the impossible a mote of dust suspended in a sunbeam hearts of the stars descended from astronomers how far away. How far away rings of Uranus realm of the galaxies made in the interiors of collapsing stars across the centuries ship of the imagination? How far away emerged into consciousness a still more glorious dawn awaits across the centuries vanquish the impossible emerged into consciousness and billions upon billions upon billions upon billions upon billions upon billions upon billions.`
  }
];
